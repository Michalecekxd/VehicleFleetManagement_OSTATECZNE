        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SemiTrailerId = table.Column<int>(type: "integer", nullable: true),
                    BodyworkType = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Breakdowns_Vehicles_VehicleId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, "Owner", "OWNER", 1 },
                    { 2, null, "Driver", "DRIVER", 2 }
                });

            migrationBuilder.CreateIndex(
                name: "IX_Breakdowns_VehicleId",
                table: "Breakdowns",
                column: "VehicleId");
