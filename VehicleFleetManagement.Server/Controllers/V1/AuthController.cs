...
{
    [ApiVersion("1.0")]
    //[ApiVersion("2.0")] // jak bedzie kolejna wersja to dodajemy metode oprocz tej co jest np. Login (zmienic mozemy na LoginV!) i oprocz tego dodajemy np. LoginV2 i w niej [MaptoApiVersion[2.0)]  
